...
class DBHelperOld {
  ...
  Future<List<double>> getMacrosComida(String id) {
    var random = Random();
    return Future.delayed(
      Duration(seconds: 3),
      () => [
  ...
  Future<List<double>> getObjetivoDiario() {
    var random = Random();
    return Future.delayed(
      Duration(seconds: 3),
      () => [
  ...
  Future<List<double>> getObjetivoGral() {
    var random = Random();
    return Future.delayed(
      Duration(seconds: 3),
  ...
  Future<List<Tuple<double, DateTime>>> getPesos(int periodo) {
